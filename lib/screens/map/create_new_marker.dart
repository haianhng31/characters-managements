...
class _CreateMarkerWindowState extends State<CreateMarkerWindow> {
  ...
  // late List<Character> _selectedCharacterAssociated;
  final _selectedCharacterAssociated = [
    Character(id: 'defs', name: 'hennessy', slogan: 'sdhfs', vocation: Vocation.junkie)
  ];
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              final newMarker = MarkerWindowModel(
                                ...
                                charactersAssociated: _selectedCharacterAssociated,
